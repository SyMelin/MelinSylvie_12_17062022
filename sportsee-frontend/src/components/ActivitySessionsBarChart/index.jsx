...
function ActivitySessionsBarChart({activitySessions}) {
    ...
    return (
        <ResponsiveContainer width="100%" height="100%">
            <BarChart data={activitySessions} width="100%" height="100%"/*width={835} height={320}*/ margin={{top: 95, right: 29, left: 0, bottom: 23}} barGap={8} >
                ...
                <Tooltip offset={20} cursor={{ fill: '#C4C4C4', opacity: 0.5, width: 56 }} content={<CustomTooltipBarChart />} />
                <Legend
                    iconType='circle'
                    iconSize='8'
