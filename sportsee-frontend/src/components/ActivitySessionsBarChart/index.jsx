...
function ActivitySessionsBarChart({activitySessions, chartWrapper, dimensions}) {
    ...
    return (
            <BarChart
                ...
                <rect width={56} height={chartWrapper * 0.383 - 148} x={cursorX - 56/2} y={95} fill= "#C4C4C4" opacity={0.5} />
                ...
                <Legend
                    ...
                    align= 'right'
                    wrapperStyle={{ top: 20, left: 44, lineHeight: '40px', fontSize: '14', fontWeight: 500 }}
